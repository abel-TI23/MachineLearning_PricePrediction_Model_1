...
# === Logging awal ===
st.write("Aplikasi dimuat dengan sukses!")

# === Load data harga historis ===
@st.cache_data
...
# === Tambahkan fitur dan indikator teknikal ===
...
if ticker:
    try:
        ...
        # Tambahkan prediksi historis jika dicentang
        if show_hist_chart:
            try:
                ...
                st.warning("⚠️ Gagal menambahkan garis prediksi historis.")
                st.text(str(e))
        ...
        fig.update_layout(title=f"{ticker} - Harga Penutupan & Prediksi",
